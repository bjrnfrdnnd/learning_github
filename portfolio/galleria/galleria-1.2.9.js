...
//var lightboxCaption="TitleAndDescription";
//var lightboxCaption="Title";
var lightboxCaption="Description";
...
Galleria = function() {
    ...
    var lightbox = this._lightbox = {
        ...
        init : function() {
            ...
            var elems = 'overlay box content shadow title TitleDescriptionSeparator description info close prevholder prev nextholder next counter image',
                el = {},
                op = self._options,
                css = '',
                ...
                cssMap = {
                    ...
                    title:      'float:left;',
                    description:'float:left;padding-left:4px',
                    TitleDescriptionSeparator:       'float:left;',
            ...
            if (lightboxCaption=="Title") harakiri.info = 'title counter';
            if (lightboxCaption=="TitleAndDescription") harakiri.info = 'title TitleDescriptionSeparator description counter';
            if (lightboxCaption=="Description") harakiri.info = 'description counter';

            $.each(harakiri, function( key, val ) {
                    var arr = [];
        ...
        show: function(index) {
            ...
            lightbox.image.load( data.iframe || data.big || data.image, function( image ) {
                ...
                lightbox.elems.description.innerHTML = data.description || '';
                lightbox.elems.TitleDescriptionSeparator.innerHTML = "";
                if (data.description && lightboxCaption=="TitleAndDescription" ) 
                    lightbox.elems.TitleDescriptionSeparator.innerHTML = ':';
